...
public class Jr2d2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonOkCoupon = new javax.swing.JButton();
        ...
        labelTipTotal.setText("Propina: $0.00");
        ...
        buttonTip1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonTip1ActionPerformed(evt);
            }
        });
        ...
        buttonTip4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonTip4ActionPerformed(evt);
            }
        });

        buttonTip3.setText("15%");
        buttonTip3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttonTip3ActionPerformed(evt);
            }
        });
        ...
        labelStatus.setText("Estado de envío:");

        labelDate.setText("Fecha del pedido:");
        ...
        try{JFileChooser fileChooser = new JFileChooser();
           ...
           if(fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION){
               ...
               String contenido = new String(fileBytes, StandardCharsets.UTF_8);
                ...
                labelDate.setText("Fecha del pedido: " + format1.format(ticket.getDateOrder()));
                labelUsername.setText("Entregar a: " + ticket.getClient().getName());
                labelEmail.setText("Email: " + ticket.getClient().getEmail());
                labelAdress.setText("Direccion de Entega: " + ticket.getClient().getAddress());
                checkBoxPhoneNumber.setText (ticket.getClient().getPhoneNumber().toString());
                labelStatus.setText("Estado de envío: " + ticket.getDelivery().getDeliveryStatus());
                labelDiscount.setText("Descuento: $0.00");
...
/*Aqui termina la funcion del boton para seleccionar archivo, junto con el deserializador*/
    ...
    private void buttonTip4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTip4ActionPerformed
            Operation calc = new Operation();
            try{tip = calc.calcMultiplication(subtotal, .2);
            labelTipTotal.setText("Propina: $" + tip);
            double totalTip = (total + tip);
            labelTotal.setText("Total: $" + totalTip);}
            catch(Exception ex){
            System.err.println(ex.getMessage());}
    }//GEN-LAST:event_buttonTip4ActionPerformed

    private void buttonTip3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTip3ActionPerformed
            Operation calc = new Operation();
            try{tip = calc.calcMultiplication(subtotal, .15);
            labelTipTotal.setText("Propina: $" + tip);
            double totalTip = (total + tip);
            labelTotal.setText("Total: $" + totalTip);}
            catch(Exception ex){
            System.err.println(ex.getMessage());}
    }//GEN-LAST:event_buttonTip3ActionPerformed

    private void buttonOkCouponActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonOkCouponActionPerformed
        try{
        for(int a = 0; a < coupons.length; a++){
            String coup = textFieldCupon.getText();
            if(coupons[a].equals(coup)){
                labelCouponConfirm.setText("Cupón canjeado con éxito");
                labelDiscount.setText("Descuento: $" + discount);
                total -= discount;
                labelTotal.setText("Total: $ " + total);
                break;
            }
            else{
                labelCouponConfirm.setText("Cupón invalido");
            }
        }
        }
        catch(Exception ex){
...
/*Aqui terminan las funciones de los botones de las propinas*/
    ...
    private javax.swing.JButton buttonOkCoupon;
